      ...
      <div className="onboarding-content">
        {step === 'welcome' && (
          <>
            <div className="ob-welcome-logo">
              <span className="brand-tile"><img src={logoUrl} width={48} height={48} alt="" /></span>
            </div>
            ...
            <div className="ob-features">
              ...
              <div className="ob-feature">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 3v18h18"/><path d="M7 15l4-6 4 3 5-7"/></svg>
                <div><b>Listening stats</b><span>Play history stays in a local database</span></div>
              </div>
              <div className="ob-feature">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M12 8v8M8 12h8"/></svg>
        ...
        {step === 'privacy' && (
          <>
            ...
            <div className="ob-feature">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
